  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 bg-[length:200%_100%] text-amber-950 font-bold tracking-wider shadow-[0_0_30px_hsl(45_100%_55%_/_0.3)] hover:bg-[position:100%_0] hover:shadow-[0_0_40px_hsl(45_100%_55%_/_0.5)] hover:scale-[1.03] transition-all duration-500",
